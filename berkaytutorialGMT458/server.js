...
const app = express();
const pool=new pg({host:'ec2-46-137-84-173.eu-west-1.compute.amazonaws.com',database:'db3t24kssmaak2',user:'hmpblglhehuzga',password:'c35b1165332e26da52521ba5a0f83dceffcfa1e18a3fa83159a10d7ec74586d2',port:'5432',ssl:{rejectUnauthorized:false}});
